...
ActiveRecord::Schema[8.0].define(version: 2025_08_29_092636) do
  ...
  create_table "admin_users", force: :cascade do |t|
    ...
    t.index ["brand_id"], name: "index_admin_users_on_brand_id"
  ...
  create_table "brands", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "sortorder", default: "created_at", null: false
  ...
  add_foreign_key "admin_users", "brands"
